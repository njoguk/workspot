...
export function CheckInBar({ onOpen }: { onOpen: () => void }) {
  return (
    <button
      ...
      className="flex min-h-[44px] w-full items-center justify-between gap-3 rounded-lg bg-dark px-4 py-4 text-left shadow-lg transition-colors duration-fast hover:bg-dark-alt"
    >
